    <header>
        <div class="container">
            <div class="intro-text" style="padding-top: 100px; padding-bottom: 100px;">
                <h1>Application For Membership</h2>
            </div>
        </div>
    </header>

    <section id="application" class="bg-light-gray" align="center" style="padding-top: 50px">
        <div class="container">
            <?php echo form_open('signup'); ?>
                <div class="row">
                    <!--<div class="col-sm-6">
                        <div class="form-inline">
                            Date received by Edifying Ministry: <input type="text" class="form-control" id="datereceived" name="datereceived" value="<?php echo set_value('datereceived'); ?>">
                        </div>
                    </div>-->
                    <div class="col-sm-3">
                        <label>
                ...
                <div class="well">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="smiddlename" class="control-label">Middle Name:</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <!--<div class="form-group">
                                <label for="datemarried" class="control-label">Date Married:</label>
                                <input type="text" class="form-control" id="datemarried" name="datemarried" placeholder="Enter Date Married" value="" />
                            </div>-->
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <!--<div class="form-group">
                                <label for="sbirthdate" class="control-label">Birthday of Spouse:</label>
                                <input type="text" class="form-control" id="sbirthdate" name="sbirthdate" placeholder="Enter Birthday of Spouse" value="" />
                            </div>-->
                        </div>
                    </div>
                    <div class="row">
