            ...
            <div class="row">
                ...
                <div class="col-sm-4 text-right main-btn">
                    <div class="btn-group btn-group pull-right">
                        <a class="btn btn-info" href="#"><span class="glyphicon glyphicon-file"></span> View Form</a><a class="btn btn-warning" href="<?php echo base_url('admin/members/edit/'.$membership_id); ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a><a class="btn btn-danger" href="<?php echo base_url('admin/members/reject/'.$membership_id); ?>"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                    </div>
                </div>
            </div>
            <hr />
