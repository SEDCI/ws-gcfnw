            ...
            <div class="row">
                ...
                <div class="col-sm-5 text-right main-btn">
                    <div class="pull-right">
                        <a class="btn btn-warning" href="<?php echo base_url('admin/pages/home/edit'); ?>"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                    </div>
                </div>
            </div>
            <hr />
            <?php echo form_open('admin/home/edit'); ?>
                <div class="row">
                    <div class="col-sm-12">
                        <h4>A. TITLE</h4>
                    </div>
