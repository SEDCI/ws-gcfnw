...
?>
					<tr>
						...
						<td><div class="btn-group"><a class="btn btn-sm btn-default glyphicon glyphicon-eye-open" title="View Event" href="<?php echo base_url('admin/pages/events/view/'.$event['id']); ?>"></a><a class="btn btn-sm btn-default glyphicon glyphicon-pencil" title="Edit" href="<?php echo base_url('admin/pages/events/edit/'.$event['id']); ?>"></a><a class="btn btn-sm btn-default glyphicon glyphicon-trash delevent" title="Delete" href="<?php echo base_url('admin/pages/events/delete/'.$event['id']); ?>"></a></div></td>
					</tr>
