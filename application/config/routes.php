...
$route['admin/pages/home'] = 'admin/applicants/rejectApplication/$1';
$route['admin/pages/events'] = 'admin/applicants/rejectApplication/$1';
$route['admin/pages/gallery'] = 'admin/applicants/rejectApplication/$1';
$route['admin/pages/about'] = 'admin/applicants/rejectApplication/$1';
